...
$(document).ready(function() {
	$('#editordiv').on('drop', function(event) {
...
//        var selectedRange = selection.getRangeAt(0);
        ...
        console.debug("cursel: " + selectedText + "; range: " + range + "; " + anchornode + "; " + focusnode + "; " + event.target);
        storeDroppedImage(event.target, range, files[0], data);
