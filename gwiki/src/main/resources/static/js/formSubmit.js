...
/**
 * WARNUNG: Sollte nur verwendet werden, wenn es innerhalb der Seite nur EIN
 * Formular gibt! Hier wird das erste Formular submitted!
 * 
 * Submitted ein Formular und hängt den Namen der Stripes-Event-Methode an den
 * Request dran.
 */
function ok(button) {
	/*
	 * Is equivalent (for stripes) as clicking on a submit button with the name
	 * button.
	 */
...
function ok3(button, formName, payload) {
	/*
	 * Is equivalent (for stripes) as clicking on a submit button with the name
	 * button.
	 */
