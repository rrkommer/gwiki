(function() {
	...
	tinymce.create('tinymce.plugins.GWikiEditor', {
		/**
		...
		ed.addCommand('mceGWikiInsertLink', function() {
	 ...
	 * @return {tinymce.ui.Control} New control instance or null if no control was
	 *         created.
	 */
