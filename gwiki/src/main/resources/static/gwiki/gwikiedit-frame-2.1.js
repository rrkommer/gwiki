...
function gwikiCreateTiny(partName, content) {
	...
	tinyMCE
			.init( {
				...
				plugins : "-gwiki,-gwikiEditorLevel,advhr,pagebreak,style,layer,table,searchreplace,print,contextmenu,noneditable,paste,iespell,inlinepopups,xhtmlxtras,emotions,spellchecker,fullscreen",
				// Theme options
...
//																					200);
						...
						if (gwikiRteDefault) {
							//$tabs.tabs( "select" , 1);
							console.info("select tabs not supported");
						} 
